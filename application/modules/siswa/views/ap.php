  ...
  <link rel="stylesheet" href="<?php echo admin_theme_locations();?>plugins/datatables/dataTables.bootstrap.css">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-th"></i> Data Siswa Administrasi Perkantoran</li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1-1">
               <section class="content">
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="satu1ap" class="table table-bordered table-striped">
                      <thead>
                      <tr>
              ...
              <div class="tab-pane" id="tab_2-2">
               <section class="content">
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="dua1ap" class="table table-bordered table-striped">
                      <thead>
                      <tr>
                        <th>Rendering engine</th>
                        <th>Browser</th>
              ...
              <div class="tab-pane" id="tab_3-2">
                ...
                <div class="box">
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <table id="tiga1ap" class="table table-bordered table-striped">
                      <thead>
                      <tr>
                        <th>Rendering engine</th>
                        <th>Browser</th>
